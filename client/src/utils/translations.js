export const translations = {
  ...
  bn: {
    ...
    product: 'পণ্য',
    inventory: 'ইনভেন্টরি',
    orders: 'ড্রাফট অর্ডারস',
    offers: 'অফার',
    draft_center: 'ড্রাফট সেন্টার',
    knowledge_gaps: 'নলেজ গ্যাপস',
    knowledge_base: 'নলেজ বেস',
    blueprint_architect: 'ব্লুপ্রিন্ট আর্কিটেক্ট',
    media_browser: 'মিডিয়া ব্রাউজার',
    ai_sandbox: 'এআই ট্রেইনার ও চ্যাট',
    growth_engine: 'গ্রোথ ইঞ্জিন',
    campaign_wizard: 'ক্যাম্পেইন উইজার্ড',
    crm_intelligence: 'সিআরএম ইন্টেলিজেন্স',
    theme: 'থিম',
    language: 'ভাষা',
    dark: 'ডার্ক',
    light: 'লাইট',
